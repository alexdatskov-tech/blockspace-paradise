  ...
  head: () => ({
    meta: [
      { title: "About the Platform — BlockForge" },
      {
        name: "description",
        content:
          "Learn about the open-source tools and security foundations behind the BlockForge Minecraft hosting experience.",
      },
      { property: "og:title", content: "About the Platform — BlockForge" },
      {
        property: "og:description",
        content: "The tools, security, and open-source projects behind BlockForge.",
      },
        ...
        <div className="relative mx-auto max-w-6xl">
          ...
          <div className="animate-rise-soft max-w-3xl pb-28 pt-32">
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-muted-foreground">
              BlockForge brings dependable infrastructure together with respected open-source tools
              to create a calmer way to run Minecraft servers.
            </p>
          </div>
        </div>
      </section>
